...
public class CodeGenerator {
    ...
    private static final String JDBC_URL = "jdbc:mysql://52.79.88.47:3306/kococo?useSSL=false&amp;serverTimezone=UTC";
    private static final String JDBC_USERNAME = "kococo";
    ...
    public static void main(String[] args) {
    	...
    	genCode("admin");
    	genCode("analysis");
    	genCode("analysis_details");
    	genCode("code");
    	genCode("record");
    	genCode("spring_session");
    	genCode("spring_session_attributes");
    	genCode("user");
